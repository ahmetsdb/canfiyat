        ...
        if (activeView === "rows") {
          const rowHtml = `
            <div class="glass-card rounded-2xl p-4 border border-slate-800/90 hover:border-emerald-500/40 flex flex-col justify-between gap-3.5 bg-slate-950/90 shadow-xl transition-all">
              ...
              <!-- DİKEY, KONFORLU VE RAHAT OKUNUR RESMİ FATURA DÖKÜM ÇEKMECESİ -->
              ${isBreakdownOpen ? `
                <div class="bg-slate-950/95 p-3.5 sm:p-4 rounded-xl border border-slate-700/80 text-xs space-y-2 animate-slide-up max-w-3xl my-2 shadow-xl">
                  ...
                  <!-- KALEM 1 -->
                  <div onclick="toggleLayer2BreakdownInfo('${product.id}', 'item1')" class="cursor-pointer hover:bg-slate-900/90 py-2 px-3 rounded-lg transition-all border border-slate-800/80">
                    <div class="flex items-center justify-between text-slate-100 font-bold text-xs">
                      <span class="flex items-center gap-1.5 text-slate-200">
                        ...
                        <span class="text-[10px] text-sky-400 bg-sky-950/80 px-1.5 py-0.2 rounded border border-sky-800/80">ℹ️ Formül / Detay</span>
                      </span>
                    ...
                    ${openLayer2BreakdownInfos[product.id]?.item1 ? `
                      <div class="mt-2 p-2.5 bg-slate-900 rounded-lg border border-sky-500/40 text-xs text-sky-200 space-y-1.5 animate-slide-up">
                  ...
                  <!-- KALEM 2 -->
                  <div onclick="toggleLayer2BreakdownInfo('${product.id}', 'item2')" class="cursor-pointer hover:bg-slate-900/90 py-2 px-3 rounded-lg transition-all border border-slate-800/80">
                    <div class="flex items-center justify-between text-slate-100 font-bold text-xs">
                      <span class="flex items-center gap-1.5 text-slate-200">
                        2. 🍾 Ambalaj Maliyeti (${layer2GroupMode === 'wholesale_drums' ? 'Sanayi Bidonları' : 'Şişe + Kapak + Kutu'})
                        <span class="text-[10px] text-sky-400 bg-sky-950/80 px-1.5 py-0.2 rounded border border-sky-800/80">ℹ️ Detay</span>
                      </span>
                  ...
                  <!-- KALEM 3 -->
                  <div onclick="toggleLayer2BreakdownInfo('${product.id}', 'item3')" class="cursor-pointer hover:bg-slate-900/90 py-2 px-3 rounded-lg transition-all border border-slate-800/80">
                    <div class="flex items-center justify-between text-slate-100 font-bold text-xs">
                      <span class="flex items-center gap-1.5 text-slate-200">
                        3. ⚡ Tesis & Enerji Masraf Payı ${supplyType === 'wholesale' ? '(0 ₺ Toptan Alış)' : ''}
                        <span class="text-[10px] text-purple-400 bg-purple-950/80 px-1.5 py-0.2 rounded border border-purple-800/80">ℹ️ Detay</span>
                      </span>
                    ...
                    ${openLayer2BreakdownInfos[product.id]?.item3 ? `
                      <div class="mt-2 p-2.5 bg-slate-900 rounded-lg border border-purple-500/40 text-xs text-purple-200 space-y-1.5 animate-slide-up">
                  ...
                  <!-- KALEM 4 -->
                  <div onclick="toggleLayer2BreakdownInfo('${product.id}', 'item4')" class="cursor-pointer hover:bg-slate-900/90 py-2 px-3 rounded-lg transition-all border border-slate-800/80">
                    <div class="flex items-center justify-between text-slate-100 font-bold text-xs">
                      <span class="flex items-center gap-1.5 text-slate-200">
                        4. 🛠️ Dolum & Paketleme İşçilik Payı
                        <span class="text-[10px] text-indigo-400 bg-indigo-950/80 px-1.5 py-0.2 rounded border border-indigo-800/80">ℹ️ Formül / Detay</span>
                      </span>
                    ...
                    ${openLayer2BreakdownInfos[product.id]?.item4 ? `
                      <div class="mt-2 p-2.5 bg-slate-900 rounded-lg border border-indigo-500/40 text-xs text-indigo-200 space-y-1.5 animate-slide-up">
