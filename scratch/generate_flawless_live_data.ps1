...
$dataObj = [ordered]@{
    ...
    "T.0077" = @{ id = "T.0077"; sku = "T.0077"; name = "HİNDİSTAN CEVİZİ YAĞI"; url = "https://www.cansizzadeyag.com/urun/hindistan-cevizi-yagi-1-kg"; samplePrices = @{ "50ml" = 290; "250ml" = 350; "1000ml" = 750 }; hasSitePrice = $true }
    ...
    "T.0080" = @{ id = "T.0080"; sku = "T.0080"; name = "KABAK ÇEKİRDEĞİ YAĞI"; url = "https://www.cansizzadeyag.com/urun/kabak-cekirdegi-yagi-1-kg"; samplePrices = @{ "50ml" = 110; "100ml" = 150; "250ml" = 350; "1000ml" = 600 }; hasSitePrice = $true }
    ...
    "T.0083" = @{ id = "T.0083"; sku = "T.0083"; name = "KETEN TOHUMU YAĞI"; url = "https://www.cansizzadeyag.com/urun/keten-tohumu-yagi-1-kg"; samplePrices = @{ "50ml" = 150; "100ml" = 180; "250ml" = 225; "1000ml" = 450 }; hasSitePrice = $true }
    ...
    "T.0110" = @{ id = "T.0110"; sku = "T.0110"; name = "JOJOBA YAĞI"; url = "https://www.cansizzadeyag.com/urun/jojoba-yagi-1-kg"; samplePrices = @{ "250ml" = 450; "1000ml" = 1500 }; hasSitePrice = $true }
    ...
    "T.0155_sabit" = @{ id = "T.0155_sabit"; sku = "T.0155"; name = "HİNT YAĞI"; url = "https://www.cansizzadeyag.com/urun/hint-yagi-1-kg"; samplePrices = @{ "250ml" = 250; "1000ml" = 550 }; hasSitePrice = $true }
    ...
    "T.0210" = @{ id = "T.0210"; sku = "T.0210"; name = "MENENGİÇ TOHUMU YAĞI (bıttım)"; url = "https://www.cansizzadeyag.com/urun/menengic-tohumu-yagi-1kg"; samplePrices = @{ "250ml" = 350; "1000ml" = 650 }; hasSitePrice = $true }
    "T.0213" = @{ id = "T.0213"; sku = "T.0213"; name = "HAŞHAŞ TOHUMU YAĞI"; url = "https://www.cansizzadeyag.com/urun/hashas-tohumu-yagi-1-kg"; samplePrices = @{ "250ml" = 400; "1000ml" = 800 }; hasSitePrice = $true }
    ...
    "T.0224" = @{ id = "T.0224"; sku = "T.0224"; name = "KAKAO YAĞI"; url = "https://www.cansizzadeyag.com/urun/kakao-yagi-1-kg"; samplePrices = @{ "50ml" = 200; "250ml" = 350; "1000ml" = 650 }; hasSitePrice = $true }
    ...
    "T.0353" = @{ id = "T.0353"; sku = "T.0353"; name = "DEFNE TOHUMU YAĞI"; url = "https://www.cansizzadeyag.com/urun/defne-tohumu-yagi-1-kg"; samplePrices = @{ "250ml" = 350; "500ml" = 550; "1000ml" = 950 }; hasSitePrice = $true }
...
# Serialize to JS
$jsLines = @()
$jsLines += "// Official Audited Retail Live Site Data mapped directly from GOOGLE-MERCHANT.xml"
...
Write-Host "Updated js/liveSiteData.js with PERFECT AUDITED RETAIL DATA successfully!"
