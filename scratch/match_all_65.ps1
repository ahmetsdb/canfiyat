...
$stemMap = @{
    ...
    "U.0248" = "okaliptus|okaliptus"
    "U.0160" = "paculi|patcoli"
    "U.0159" = "palmarosa"
    "U.0308" = "mandalina"
    "U.0314" = "sedir"
    "U.0411" = "tarcin"
...
Write-Host "`n=== MATCH SUMMARY ==="
Write-Host "Sitede Bulunan Ürün Sayısı:" $foundCount
Write-Host "Sitede Olmayan (N/A Gösterilecek):" $notFoundCount

# Serialize to JS
$jsLines = @()
$jsLines += "// Official Accurate Live Site Data mapped from GOOGLE-MERCHANT.xml"
...
Write-Host "Updated js/liveSiteData.js successfully!"
